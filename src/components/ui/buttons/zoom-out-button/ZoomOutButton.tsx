...
export const ZoomOutButton = ({
  ...
  return (
    ...
    >
      <span
        className={twMerge(
          ...
          hasTitleAndDescription
            ? 'group-hover:top-[28%] group-hover:size-[1.68269rem] md:group-hover:size-[2.375rem]'
            : 'group-hover:top-[39%] group-hover:size-[2.36905rem] md:group-hover:size-[3.34375rem]',
      ...
      >
        <span
          className={twMerge('text-xxs font-medium md:text-xs', 'group-hover:text-white-primary')}
        >
          {title}
        </span>
        <span
